...
After a couple of months of heads-down development, models, game-mastering, bug fixing, and post-mortems, this week the team finally settled back into their usual working rhythms. What's left is a working game and a key learning: simulations like this must have a deep integration with pop-up economies with. No compromises. This will be a requirement for when the simulation will be played agai. Sadly, what's also left is a deep hole in our multisig-pockets. The [Gitcoin Grant](https://gitcoin.co/grants/127/planet-a?tab=activity) the team had initially set up to back the Social Dist0rtion Protocol token, was able to collect 3,453.25 DAI ([Gitcoin is showing an invalid balance](https://etherscan.io/address/0x527621278422FFf45A66f7086bAeAC770CF12b69)), while a total of [17,175.50 SDP](https://etherscan.io/token/0x9272fd58aba57f4b73049d719abc9053cebfa679) were issued and paid out to contributors. The token had been issued as a debt instrument initially, to track contributions and a final exchange rate of 1 SDP = 1 DAI had been intended. But there's still time to fill the gap. EthBerlin pledged 1k-2.5k DAI. Gitcoin promised to match contributions. But even in the best case scenario (2.5k DAI from EthBerlin + 100% Gitcoin matching: `(3,453.25 DAI + 2,500 DAI) * 2 = 11,906.50 DAI`), Social Dist0rtion Protocol's multi-signature wallet technically still owes a total of 5,269.00 DAI to its tirelessly-working contributors.
