...
<style>
  ...
  @media screen and (max-width: 360px) {
    ...
    .menu-icon-link img[width="26"] {
      width: 20px;
      height: 20px;
    }

    .menu-icon-link img[width="32"] {
      width: 24px;
      height: 24px;
    }
  }
...
<menu class="menu">
  <ul>
    ...
    <li>
      <a rel="prefetch" href="/validator">Validator</a>
    </li>
    <li>
    ...
    <li>
      <a
        ...
        target="_blank"
        rel="noopener">
        <img src="/img/twitter.svg" alt="twitter icon" width="26" height="26" />
      </a>
    </li>
    <li>
      <a
