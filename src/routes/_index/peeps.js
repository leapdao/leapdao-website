export const locations = {
  ...
  grandRap: [42.9632, -85.6679],
  bratsk: [56.16667, 101.61667],
  moscow: [55.75583, 37.61778],
  ljubljana: [46.05, 14.51667],
  vegas: [36.1699, -115.1398],
  prague: [50.08861, 14.42139],
  seva: [44.6054, 33.5221],
  hochi: [10.8231, 106.6297],
  hanover: [52.375, 9.7348],
  travel: [5.9788, 116.0753],
  hyderabad: [17.448157, 78.348948],
  uyo: [7.93, 5.03],
